...
export const translations = {
  dari: {
    ...
    savedItems: 'محصولات ذخیره شده',
    noFavorites: 'هنوز محصولی به علاقه‌مندی‌ها اضافه نکرده‌اید',
  ...
  pashto: {
    ...
    shipped: 'لیږل شوی',
    delivered: 'تحویل شوی',
    noOrders: 'تاسو لا تر اوسه کوم امر راجستر کړی نه دی',
    startShopping: 'پیرود پیل کړئ',
    savedItems: 'خوندي شوي محصولات',
    noFavorites: 'تاسو لا تر اوسه کوم محصول خوښو ته اضافه کړی نه دی',
    shippingAddresses: 'د لیږد پتې',
    addNewAddress: 'نوې پته اضافه کړئ',
    defaultAddress: 'اصلي پته',
    editAddress: 'سمول',
    deleteAddress: 'حذف',
